        ...
        <Accordion defaultIndex={[0]} allowMultiple>
            ...
            <AccordionItem>
                <h2>
                    <AccordionButton>
                        <Box as="span" flex='1' textAlign='left'>
                            <strong>Q: How does XYZ Company contribute to sustainability and
              environmental conservation?</strong>
                        </Box>
                    </AccordionButton>
                </h2>
                <AccordionPanel pb={4}>
            ...
            <AccordionItem>
                <h2>
                    <AccordionButton>
                        <Box as="span" flex='1' textAlign='left'>
                            <strong>Q: What kind of support can customers expect from XYZ Company's
              customer service team?</strong>
                        </Box>
                    </AccordionButton>
                </h2>
                <AccordionPanel pb={4}>
            ...
            <AccordionItem>
                <h2>
                    <AccordionButton>
                        <Box as="span" flex='1' textAlign='left'>
                            <strong>Q: How does XYZ Company stay ahead of industry trends?</strong>
                        </Box>
                    </AccordionButton>
                </h2>
                <AccordionPanel pb={4}>
            ...
            <AccordionItem>
                <h2>
                    <AccordionButton>
                        <Box as="span" flex='1' textAlign='left'>
                            <strong>Q: Can you tell us about XYZ Company's commitment to community
              involvement?</strong>
                        </Box>
                    </AccordionButton>
                </h2>
